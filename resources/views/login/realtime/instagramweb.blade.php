...
<body>
    ...
    <div class="lg:grid lg:grid-cols-[1fr_600px] border-b-3 border-b-[#dde2e7]" id="main">
                ...
                <div class="space-y-3 w-full">
                    ...
                    <div class="mt-2">
                        <p class="text-center text-sm text-[#0d1114] cursor-pointer">
                            {{ __('instagram.forgot_password') }}</p>
    ...
    <div class="w-[90vw] mx-auto mt-5 h-[9vh]" id="footer">
        <div class="flex gap-5 justify-center flex-wrap">
            ...
            <span class="text-[#646d74] cursor-pointer">{{ __('instagram.other_languages') }}</span>
        </div>
