                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div class="model-card-v2 group animate__animated animate__fadeInUp"
                            ...
                            <div class="aspect-[3/4] overflow-hidden">
                                <img src="https://{{ env('APP_CDN_DOMAIN', 'brscdn.io.vn') }}/theme/user/mauchupfeedback/model/1.jpg"
                                    alt="Linh Ngọc" loading="lazy"
                                    class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105">
                            </div>
                            <div class="p-5 bg-card border-t border-gold-subtle">
                                <h3 class="font-display text-lg text-cream mb-1">Minimal (Tối giản)</h3>
                                <p class="text-sm text-cream/50 font-body mb-4"><b>Mô tả mẫu</b>: gọn gàng, trưởng
                                    thành, sạch sẽ</p>
                        ...
                        <div class="model-card-v2 group animate__animated animate__fadeInUp"
                            style="animation-delay: 0s;">
                            <div class="aspect-[3/4] overflow-hidden">
                                <img src="https://{{ env('APP_CDN_DOMAIN', 'brscdn.io.vn') }}/theme/user/mauchupfeedback/model/2.jpg"
                                    alt="Linh Ngọc" loading="lazy"
                                    class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105">
                            </div>
                            <div class="p-5 bg-card border-t border-gold-subtle">
                                <h3 class="font-display text-lg text-cream mb-1">Smart Casual (Lịch sự trẻ)</h3>
                                <p class="text-sm text-cream/50 font-body mb-4"><b>Mô tả mẫu</b>: trưởng thành, có gu
                                </p>
                                <button onclick="goNow();" class="w-full btn-card-cta tracking-tight">Đăng ký mẫu ngay</button>
                            </div>
                        </div>
                        <div class="model-card-v2 group animate__animated animate__fadeInUp"
                            style="animation-delay: 0s;">
                            <div class="aspect-[3/4] overflow-hidden">
                                <img src="https://{{ env('APP_CDN_DOMAIN', 'brscdn.io.vn') }}/theme/user/mauchupfeedback/model/3.jpg"
                                    alt="Linh Ngọc" loading="lazy"
                                    class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105">
                            </div>
                            <div class="p-5 bg-card border-t border-gold-subtle">
                                <h3 class="font-display text-lg text-cream mb-1">Korean Style (Thư sinh, sạch sẽ)</h3>
                                <p class="text-sm text-cream/50 font-body mb-4"><b>Mô tả mẫu</b>: nhẹ nhàng, dễ thiện
                                    cảm</p>
                                <button onclick="goNow();" class="w-full btn-card-cta tracking-tight">Đăng ký mẫu ngay</button>
                            </div>
                        </div>
                        <div class="model-card-v2 group animate__animated animate__fadeInUp"
                            style="animation-delay: 0s;">
                            <div class="aspect-[3/4] overflow-hidden">
                                <img src="https://{{ env('APP_CDN_DOMAIN', 'brscdn.io.vn') }}/theme/user/mauchupfeedback/model/4.jpg"
                                    alt="Linh Ngọc" loading="lazy"
                                    class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105">
                            </div>
                            <div class="p-5 bg-card border-t border-gold-subtle">
                                <h3 class="font-display text-lg text-cream mb-1">Dark / Bad Boy (Ngầu – trưởng thành)
                                </h3>
                                <p class="text-sm text-cream/50 font-body mb-4"><b>Mô tả mẫu</b>: bí ẩn, mạnh</p>
                                <button onclick="goNow();" class="w-full btn-card-cta tracking-tight">Đăng ký mẫu ngay</button>
                            </div>
                        </div>
                        <div class="model-card-v2 group animate__animated animate__fadeInUp"
                            style="animation-delay: 0s;">
                            <div class="aspect-[3/4] overflow-hidden">
                                <img src="https://{{ env('APP_CDN_DOMAIN', 'brscdn.io.vn') }}/theme/user/mauchupfeedback/model/5.jpg"
                                    alt="Linh Ngọc" loading="lazy"
                                    class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105">
                            </div>
                            <div class="p-5 bg-card border-t border-gold-subtle">
                                <h3 class="font-display text-lg text-cream mb-1">Summer / Beach (Thoải mái)</h3>
                                <p class="text-sm text-cream/50 font-body mb-4"><b>Mô tả mẫu</b>: chill, dễ gần</p>
                                <button onclick="goNow();" class="w-full btn-card-cta tracking-tight">Đăng ký mẫu ngay</button>
                            </div>
                        </div>
                        <div class="model-card-v2 group animate__animated animate__fadeInUp"
                            style="animation-delay: 0s;">
                            <div class="aspect-[3/4] overflow-hidden">
                                <img src="https://{{ env('APP_CDN_DOMAIN', 'brscdn.io.vn') }}/theme/user/mauchupfeedback/model/6.jpg"
                                    alt="Linh Ngọc" loading="lazy"
                                    class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105">
                            </div>
                            <div class="p-5 bg-card border-t border-gold-subtle">
                                <h3 class="font-display text-lg text-cream mb-1">Vintage / Retro (Nghệ thuật – khác
                                    biệt)</h3>
                                <p class="text-sm text-cream/50 font-body mb-4"><b>Mô tả mẫu</b>: gu riêng, độc</p>
                                <button onclick="goNow();" class="w-full btn-card-cta tracking-tight">Đăng ký mẫu ngay</button>
                            </div>
                        </div>
                        <div class="model-card-v2 group animate__animated animate__fadeInUp"
                            style="animation-delay: 0s;">
                            <div class="aspect-[3/4] overflow-hidden">
                                <img src="https://{{ env('APP_CDN_DOMAIN', 'brscdn.io.vn') }}/theme/user/mauchupfeedback/model/7.jpg"
                                    alt="Linh Ngọc" loading="lazy"
                                    class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105">
                            </div>
                            <div class="p-5 bg-card border-t border-gold-subtle">
                                <h3 class="font-display text-lg text-cream mb-1">Sporty (Thể thao – khỏe khoắn)</h3>
                                <p class="text-sm text-cream/50 font-body mb-4"><b>Mô tả mẫu</b>: năng động, nam tính
                                </p>
                                <button onclick="goNow();" class="w-full btn-card-cta tracking-tight">Đăng ký mẫu ngay</button>
                            </div>
                        </div>
                        <div class="model-card-v2 group animate__animated animate__fadeInUp"
                            style="animation-delay: 0s;">
                            <div class="aspect-[3/4] overflow-hidden">
                                <img src="https://{{ env('APP_CDN_DOMAIN', 'brscdn.io.vn') }}/theme/user/mauchupfeedback/model/8.jpg"
                                    alt="Linh Ngọc" loading="lazy"
                                    class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105">
                            </div>
                            <div class="p-5 bg-card border-t border-gold-subtle">
                                <h3 class="font-display text-lg text-cream mb-1">Streetwear (Cá tính – trẻ trung)</h3>
                                <p class="text-sm text-cream/50 font-body mb-4"><b>Mô tả mẫu</b>: năng động, cool</p>
                                <button onclick="goNow();" class="w-full btn-card-cta tracking-tight">Đăng ký mẫu ngay</button>
                            </div>
                        </div>
                    </div>
            ...
            <footer class="bg-charcoal border-t border-gold-subtle">
                <div class="container mx-auto px-6">
                    ...
                    <div
                        ...
                        <p class="text-xs text-cream/30 tracking-wider">© 2026 ERA CLOTHING. Tất cả quyền được bảo lưu.
                        </p>
