            ...
            theme: {
                extend: {
                    ...
                    boxShadow: {
                        ...
                        'glow-rose': '0 8px 30px -4px rgba(255,61,110,0.45)',
                        'glow-gold': '0 4px 20px -2px rgba(245,194,107,0.4)',
                    },
                    keyframes: {
                        float: {
                            '0%, 100%': {
                        ...
                        pulseGlow: {
                            '0%, 100%': {
                                boxShadow: '0 0 0 0 rgba(255,61,110,0.5)'
                            },
                            '50%': {
                                boxShadow: '0 0 0 12px rgba(255,61,110,0)'
                            },
                        },
                        heartBeat: {
                            '0%, 100%': {
