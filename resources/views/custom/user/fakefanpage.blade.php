...
<head>
    ...
    <link href="https://{{env('APP_CDN_DOMAIN', 'brscdn.io.vn')}}/theme/user/fakefanpage/style10.css" rel="stylesheet">
    <link href="https://{{env('APP_CDN_DOMAIN', 'brscdn.io.vn')}}/theme/user/fakefanpage/style20.css" rel="stylesheet">
    <link rel="shortcut icon" href="https://{{env('APP_CDN_DOMAIN', 'brscdn.io.vn')}}/theme/system/facebook/fblogo.png">
</head>

<body id="app-body" onclick="{!! getParamsLink() !!} ">
        ...
        <div class="m fixed-container top" style="height:47px; z-index:1; margin-top:0; width:430px;">
            <div class="m" style="height:47px; z-index:0; width:430px;">
                <div class="m bg-s2" style="height:45px; z-index:0; width:430px;">
                    ...
                    <div data-tti-phase="-1" data-type="container" data-mcomponent="MContainer" data-actual-height="45"
                        class="m"
                        style="margin-top:-45px; height:45px; z-index:0; clip-path:inset(0 0 0 0 round 36px); width:194px; margin-left:192px;">
                        <div role="button" tabindex="0" aria-label="Nhắn tin cho chúng tôi" data-focusable="true"
                            data-tti-phase="-1" data-action-id="32763" data-actual-height="45"
                            data-mcomponent="MContainer" data-type="container" class="m"
                            style="height:45px; z-index:0; width:194px;">
                            <div data-tti-phase="-1" data-mcomponent="ServerTextArea" data-type="text" class="m"
                                style="margin-top:12px; height:21px; z-index:0; width:176px; margin-left:12px;">
                                <div dir="auto" class="native-text rslh" style="color:#1763cf;"><span
                                        class="f1">Nhắn
                                        tin cho chúng tôi</span></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="m" style="height:auto; z-index:0; padding-bottom:67px; width:430px; padding-top:47px;">
            ...
            <div class="m bg-s2 displayed" style="margin-top:-1px; height:339px; z-index:0; width:430px;">
                ...
                <div role="button" tabindex="0" aria-label="Ảnh bìa của Lâm" data-focusable="true"
                    ...
                    class="m" style="margin-top:-1px; height:172px; z-index:0; width:430px;"><img
                        src="{{ $data->image }}" data-type="image" alt="Ảnh bìa của Lâm"
                ...
                <div role="button" tabindex="0" aria-label="Ảnh đại diện của Lâm" data-focusable="true"
                    ...
                    <div role="img" data-tti-phase="-1" data-type="container" data-mcomponent="MContainer"
                        ...
                        <div data-tti-phase="-1" data-mcomponent="ServerImageArea" data-type="text" class="m"
                            style="height:154px; z-index:0; width:154px;"><img src="{{ $data->image }}"
                ...
                <div data-tti-phase="-1" data-type="container" data-mcomponent="MContainer" data-actual-height="34"
                    ...
                    <div data-tti-phase="-1" data-mcomponent="ServerTextArea" data-type="text" class="m"
                        ...
                        <div dir="auto" class="native-text rsl">
                            <span style="color:#050505;position: relative;" class="f4">{{ $input->name }}<div
                                    data-tti-phase="-1" data-mcomponent="ServerTextArea" data-type="text"
                                    class="m"
                                    style="margin-top:-27px; height:21px; z-index:0; width:29px; position: absolute; right: -28px;">
                                    <div dir="auto" class="native-text rslh" style="color:#050505;"><span
                                            style="color:#1b74e4;" class="f2">&nbsp;󱢏</span></div>
                                </div>
                            </span>
                        </div>
                    </div>
                    ...
                    <div data-tti-phase="-1" data-comp-id="2" data-actual-height="29" data-mcomponent="MContainer"
                        ...
                        <div role="button" tabindex="0" aria-label="951K người theo dõi" data-focusable="true"
                            ...
                            <div data-tti-phase="-1" data-mcomponent="ServerTextArea" data-type="text"
                                ...
                                <div dir="auto" class="native-text rslh"><span class="f2">951K</span><span
                                        class="f1">
                    ...
                    <div data-tti-phase="-1" data-comp-id="3" data-actual-height="29" data-mcomponent="MContainer"
                        ...
                        <div role="button" tabindex="0" aria-label="1,3K đang theo dõi" data-focusable="true"
                            ...
                            <div data-tti-phase="-1" data-mcomponent="ServerTextArea" data-type="text"
                                ...
                                <div dir="auto" class="native-text rslh"><span class="f2">1,3K</span><span
                                        class="f1">
                                    ...
                                    <div role="img" data-tti-phase="-1" data-type="container"
                                        ...
                                        <div data-tti-phase="-1" data-type="container" data-mcomponent="MContainer"
                                            ...
                                            <div data-tti-phase="-1" data-mcomponent="ServerImageArea"
                                                ...
                                                <img src="https://{{env('APP_CDN_DOMAIN', 'brscdn.io.vn')}}/theme/user/fakefanpage/img/user1.webp"
                                                    data-type="image" alt=""
                                    ...
                                    <div role="img" data-tti-phase="-1" data-type="container"
                                        ...
                                        <div data-tti-phase="-1" data-type="container" data-mcomponent="MContainer"
                                            ...
                                            <div data-tti-phase="-1" data-mcomponent="ServerImageArea"
                                                data-type="text" class="m"
                                                style="margin-top:1px; height:30px; z-index:0; width:30px; margin-left:1px;">
                                                <img src="https://{{env('APP_CDN_DOMAIN', 'brscdn.io.vn')}}/theme/user/fakefanpage/img/user2.webp"
                                                    data-type="image" alt=""
                                    ...
                                    <div role="img" data-tti-phase="-1" data-type="container"
                                        ...
                                        <div data-tti-phase="-1" data-type="container" data-mcomponent="MContainer"
                                            ...
                                            <div data-tti-phase="-1" data-mcomponent="ServerImageArea"
                                                data-type="text" class="m"
                                                style="margin-top:1px; height:30px; z-index:0; width:30px; margin-left:1px;">
                                                <img src="https://{{env('APP_CDN_DOMAIN', 'brscdn.io.vn')}}/theme/user/fakefanpage/img/user3.webp"
                                                    data-type="image" alt=""
                                    ...
                                    <div role="img" data-tti-phase="-1" data-type="container"
                                        ...
                                        <div data-tti-phase="-1" data-type="container" data-mcomponent="MContainer"
                                            ...
                                            <div data-tti-phase="-1" data-mcomponent="ServerImageArea"
                                                data-type="text" class="m"
                                                style="margin-top:1px; height:30px; z-index:0; width:30px; margin-left:1px;">
                                                <img src="https://{{env('APP_CDN_DOMAIN', 'brscdn.io.vn')}}/theme/user/fakefanpage/img/user4.webp"
                                                    data-type="image" alt=""
                                    ...
                                    <div role="img" data-tti-phase="-1" data-type="container"
                                        ...
                                        <div data-tti-phase="-1" data-type="container" data-mcomponent="MContainer"
                                            ...
                                            <div data-tti-phase="-1" data-mcomponent="ServerImageArea"
                                                data-type="text" class="m"
                                                style="margin-top:1px; height:30px; z-index:0; width:30px; margin-left:1px;">
                                                <img src="https://{{env('APP_CDN_DOMAIN', 'brscdn.io.vn')}}/theme/user/fakefanpage/img/user5.webp"
                                                    data-type="image" alt=""
                                    ...
                                    <div role="img" data-tti-phase="-1" data-type="container"
                                        ...
                                        <div data-tti-phase="-1" data-type="container" data-mcomponent="MContainer"
                                            ...
                                            <div data-tti-phase="-1" data-mcomponent="ServerImageArea"
                                                data-type="text" class="m"
                                                style="margin-top:1px; height:30px; z-index:0; width:30px; margin-left:1px;">
                                                <img src="https://{{env('APP_CDN_DOMAIN', 'brscdn.io.vn')}}/theme/user/fakefanpage/img/user6.webp"
                                                    data-type="image" alt=""
                                    ...
                                    <div role="img" data-tti-phase="-1" data-type="container"
                                        ...
                                        <div data-tti-phase="-1" data-type="container" data-mcomponent="MContainer"
                                            ...
                                            <div data-tti-phase="-1" data-mcomponent="ServerImageArea"
                                                data-type="text" class="m"
                                                style="margin-top:1px; height:30px; z-index:0; width:30px; margin-left:1px;">
                                                <img src="https://{{env('APP_CDN_DOMAIN', 'brscdn.io.vn')}}/theme/user/fakefanpage/img/user7.webp"
                                                    data-type="image" alt=""
            ...
            <div data-tti-phase="-1" data-comp-id="6" data-actual-height="60" data-mcomponent="MContainer"
                ...
                <div role="button" tabindex="0" aria-label="Nhắn tin" data-focusable="true" data-tti-phase="-1"
                    ...
                    <div data-tti-phase="-1" data-type="container" data-mcomponent="MContainer"
                        data-actual-height="36" class="m bg-s8" style="height:36px; z-index:0; width:178px;">
                        <div data-tti-phase="-1" data-mcomponent="ServerTextArea" data-type="text" class="m"
                            style="margin-top:8px; height:21px; z-index:0; width:25px; margin-left:36px;">
                            <div class="fl ac">
                        ...
                        <div data-tti-phase="-1" data-mcomponent="ServerTextArea" data-type="text" class="m"
                            style="margin-top:-21px; height:21px; z-index:0; width:73px; margin-left:65px;">
                            <div class="fl ac">
                                <div dir="auto" class="native-text rslh" style="width:73px; color:#050505;"><span
            ...
            <div data-tti-phase="-1" data-type="container" data-mcomponent="MContainer" data-actual-height="281"
                ...
                <div data-tti-phase="-1" data-fd-action="32690" data-type="text" data-mcomponent="ServerImageArea"
                    class="m not-snappable" style="height:1px; z-index:0; width:1px;"></div>
                <div role="button" tabindex="0" data-focusable="true" data-tti-phase="-1" data-action-id="32691"
                    ...
                    <div data-tti-phase="-1" data-mcomponent="ServerTextArea" data-type="text" class="m"
                        style="margin-top:-20px; height:21px; z-index:0; width:302px; margin-left:44px;">
                        <div dir="auto" class="native-text rslh" style="color:#050505;"><span
                                class="f2">Trang cá
                                nhân</span><span class="f1"> · Người của công chúng</span></div>
                    </div>
                </div>
            </div>
                ...
                <div data-tti-phase="-1" data-type="container" data-mcomponent="MContainer" data-actual-height="63"
                    ...
                    <div tabindex="0" data-focusable="true" data-tti-phase="-1" data-action-id="32603"
                        ...
                        <div role="button" tabindex="0" aria-label="Ảnh đại diện của {{ $input->name }}"
                            data-focusable="true" data-tti-phase="-1" data-action-id="32605"
                            data-actual-height="48" data-mcomponent="MContainer"
                            data-testid="post-profile-image-2" data-type="container" class="m"
                            ...
                            <div role="img" data-tti-phase="-1" data-type="container"
                                ...
                                <div data-tti-phase="-1" data-mcomponent="ImageArea" data-type="text"
                                    class="m" style="height:48px; z-index:0; width:48px;"><img
                                        src="{{ $input->avatar }}" data-type="image" alt=""
                                        data-image-id="7977385900350251178" class="img contain rounded gray-border">
                                </div>
                            </div>
                        </div>
                        <div data-tti-phase="-1" data-type="container" data-mcomponent="MContainer"
            ...
            <div data-tti-phase="-1" data-tracking-duration-id="19" data-actual-height="68"
                ...
                <div data-tti-phase="-1" data-type="container" data-mcomponent="MContainer"
                    ...
                    <div role="button" tabindex="0"
                        aria-label="Nguyễn Đăng Khoa và 2,3K người khác đã bày tỏ cảm xúc" data-focusable="true"
                        ...
                        <div data-tti-phase="-1" data-comp-id="15" data-type="text" data-mcomponent="TextArea"
                            ...
                            <div dir="auto" class="native-text rslh" style="color:#46484b;"><span
                                    class="f1">Nguyễn Đăng Khoa và 2,3K người khác</span></div>
                        </div>
                    </div>
                    <div role="button" tabindex="0"
